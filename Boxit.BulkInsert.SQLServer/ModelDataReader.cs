...
internal class ModelDataReader<TModel>(IEnumerable<TModel> entities) : IDataReader
{
    ...
    private static object? GetForeignKeyValue(TModel entity, PropertyInfo navigationProperty,
        PropertyInfo principalKeyProperty)
    {
    ...
    public ModelDataReader<TModel> WithFieldsFromDbContext(DbContext dbContext)
    {
        ...
        foreach (var prop in entityType.GetProperties())
        {
            ...
            var generatedValue = prop.ValueGenerated is ValueGenerated.OnAdd or ValueGenerated.OnAddOrUpdate ||
                                 prop.GetValueGeneratorFactory() != null;
                ...
                else
                {
                    ...
                    if (navigationProperty is null)
                    {
                        throw new NotSupportedException(
                            "Cannot work with foreign keys that don't have a navigation property.");
                    }
